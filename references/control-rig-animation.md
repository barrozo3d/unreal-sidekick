...
>
> No fabricated names found. All 4 flags are parameter names (`Collision Sphere Radius`, `Simulation Warmup Frames`) -- shown on screen, never spoken, so uncheckable here.
>
