...
**current_stable:** UE 5.7

## Known Versions

| Version | Release | Release Notes File | Status | Key Features |
|---------|---------|-------------------|--------|--------------|
| UE 5.7 | 2026 | (current docs — no separate page) | Current stable | All docs on dev.epicgames.com are 5.7 |
...
| Movie Render Graph | UE 5.4 (EA) | UE 5.6 | Replaces linear MRQ queue |
| MegaLights | UE 5.5 (Exp) | TBD | Still experimental as of 5.6 |
