...
>
> No fabricated names found. Flags are console variables and quality settings (`r.ScreenPercentage`, `Lumen Final Gather Quality`, `TraceMeshSDFs`) -- typed or shown, never spoken.
>
