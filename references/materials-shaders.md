...
>
> No fabricated names found. Flags are API symbols and code identifiers (`MaterialParameterCollection`, `SetScalarParameterValue`, `MPC`, `DynMat`) -- typed, never spoken.
>
