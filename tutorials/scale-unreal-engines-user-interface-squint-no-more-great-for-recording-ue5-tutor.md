---
title: Scale Unreal Engine's User Interface! SQUINT no more! Great for recording UE5 tutorials too!
source: YouTube
...
### Why make UI BIG? [0:00]
**Transcript:** So if you're using Unreal Engine and you want to increase the size of your menus or you're doing a demo like myself  And you want to make these bigger so no everyone's having to squint everything I'm doing  There's a hot key which calls up a menu so you hit control shift and  W it calls up the widget reflector and then you'll find that under and this is gonna pause me under tools
...
### Demo Mode - enable mouse click and hot key visualizer [0:52]
**Transcript:** You can click on mouse click and key and what that does now is  When I click on a window here like this you can see it's giving me a little dot and then when I'm gonna get rid of these icons by pressing G and I hit G  And you see down here in the bottom corner  You can see what letter on I'm pressing so all your hot keys and things like that  So that is an amazing tip and that was so it's a show me that one so thank you  It's a and then if you like nerdy stuff like this then come join me on my channel
