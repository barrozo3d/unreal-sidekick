---
title: How to get precision control in DaVinci Resolve - use Shift Drag!
source: YouTube
...
**Source:** [YouTube](https://www.youtube.com/watch?v=g9VndiQqON0)
**Author:** Dean Yurke - Unreal Engine and VFX Filmmaking
**Duration:** 0m38s | 3 section(s)
...
### How to get fine control of your volume bar [0:00]
**Transcript:** Now I'm sure it's probably just me, but I didn't know this and if you're trying to get really fine control of your audio volume inside the timeline  and then you're going to just move and go like that and it's like, well if you hold down shift and then do it, then you've got a lot more control with your mouse.

**Frame:** tutorials\frames\how-to-get-precision-control-in-davinci-resolve---use-shift-drag\frame_000.jpg

### Hold Shift for fine control. [0:16]
**Transcript:** And the crazy thing is it also works for the inspector. So if you're wanting to do a little transform, then you hold down the shift and then you get finer control.

**Frame:** tutorials\frames\how-to-get-precision-control-in-davinci-resolve---use-shift-drag\frame_001.jpg

### Also works with the numberboxes / slider in the Inspector [0:25]
**Transcript:** Hooray, isn't that brilliant? That's all folks. See you. Bye.

**Frame:** tutorials\frames\how-to-get-precision-control-in-davinci-resolve---use-shift-drag\frame_002.jpg
